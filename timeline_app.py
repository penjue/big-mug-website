...
def contact_settings():
    ...
    for key in ('instagram_url','facebook_url','tiktok_url'):
        ...
        try:
            ...
            if request.path=='/admin':
                ...
                if security_marker in page:
                    page=page.replace(security_marker,section+security_marker,1)
                else:
                ...
                page=page.replace('<a class="q" href="#security">Security</a>','<a class="q" href="#contact-reviews">Contact & Reviews</a><a class="q" href="#security">Security</a>',1)
